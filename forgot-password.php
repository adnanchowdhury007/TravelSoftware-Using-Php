...
<div class="privacy">
	...
	<p style="width: 350px;">
			...
			<b>Email id</b>  <input type="email" name="email" class="form-control" id="email" required="">
	</p> 

	<p style="width: 350px;">
		
			<b>Mobile No</b>  <input type="text" name="mobile" class="form-control" id="mobile"  required="">
	</p> 
...
<b>Confirm Password</b>
	<input type="password" class="form-control" name="confirmpassword" id="confirmpassword"  required="">
			...
			<p style="width: 350px;">
<button type="submit" name="submit50" >Change</button>
			</p>
			</form>
